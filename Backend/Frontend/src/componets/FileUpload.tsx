  ...
  const handleUpload = async () => {
    ...
    try {
      ...
      const ordrResponse = await axios.post(
        "http://192.168.2.39:8000/api/generate-ordr/",
        formData,
        {
          headers: {
      ...
      const rdr1Response = await axios.post(
        "http://192.168.2.39:8000/api/generate-rdr1/",
        formData,
        {
          headers: {
            "Content-Type": "multipart/form-data",
      ...
      setOrdrDownloadLinks({
        xlsx: `http://192.168.2.39:8000${ordrResponse.data.file_path_xlsx}`,
        txt: `http://192.168.2.39:8000${ordrResponse.data.file_path_txt}`,
      });

      // Set download links for both RDR1 .xlsx and .txt
      setRdr1DownloadLinks({
        xlsx: `http://192.168.2.39:8000${rdr1Response.data.file_path_xlsx}`,
        txt: `http://192.168.2.39:8000${rdr1Response.data.file_path_txt}`,
      });
      ...
      {ordrDownloadLinks.xlsx && (
        <div style={sectionStyle}>
          ...
          <a
            ...
            download="Generated_ORDR_Sheet.xlsx"
          ...
          <a
            ...
            download="Generated_ORDR_Sheet.txt"
            style={downloadButtonStyle}
            onMouseOver={(e) =>
              (e.currentTarget.style.backgroundColor = "#0056b3")
            }
      ...
      {rdr1DownloadLinks.xlsx && (
        <div style={sectionStyle}>
          ...
          <a
            ...
            download="Generated_RDR1_Sheet.xlsx"
            style={downloadButtonStyle}
            onMouseOver={(e) =>
              (e.currentTarget.style.backgroundColor = "#0056b3")
            }
          ...
          <a
            ...
            download="Generated_RDR1_Sheet.txt"
            style={downloadButtonStyle}
            onMouseOver={(e) =>
              (e.currentTarget.style.backgroundColor = "#0056b3")
            }
